...
namespace Dstricts.Views.BookService
{
	...
	public partial class BookServiceTimePage : ContentPage
	{
		BookServiceTimePageViewModel viewModel;
		public BookServiceTimePage()
		{
			InitializeComponent();
			NavigationPage.SetBackButtonTitle(this, "");
			BindingContext = viewModel = new BookServiceTimePageViewModel(this.Navigation);
			lblTitle.Text = "Book Date & Time";
			lblDateTimeText.Text = "Pick date & time";
		}
