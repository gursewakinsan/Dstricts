...
namespace Dstricts.Views.BookService
{
	...
	public partial class BookOpenCalenderInfoPage : ContentPage
	{
		#region Variables.
		BookOpenCalenderInfoPageViewModel viewModel;
		#endregion

		#region Constructor.
		public BookOpenCalenderInfoPage(Models.WellnessSelectedServiceInfoResponse wellnessSelected)
		{
			InitializeComponent();
			NavigationPage.SetBackButtonTitle(this, "");
			BindingContext = viewModel = new BookOpenCalenderInfoPageViewModel(this.Navigation);
			viewModel.SelectedWellnessServiceInfo = wellnessSelected;
			lblName.Text = "Date & Time";
		}
		#endregion
