...
{
    public class CommunitySelectedAmenitiesInfoResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty(PropertyName = "close_time")]
        public int CloseTime { get; set; }

        [Newtonsoft.Json.JsonProperty(PropertyName = "open_time")]
        public int OpenTime { get; set; }

        [Newtonsoft.Json.JsonProperty(PropertyName = "is_available")]
        public bool IsAvailable { get; set; }

        [Newtonsoft.Json.JsonProperty(PropertyName = "community_aminity_name")]
        public string CommunityAminityName { get; set; }

        [Newtonsoft.Json.JsonProperty(PropertyName = "open_close_timing")]
        public int OpenCloseTiming { get; set; }
        ...
        public List<CommunitySelectedAmenitiesImages> Images { get; set; }
    }

    public class CommunitySelectedAmenitiesImages
    {
